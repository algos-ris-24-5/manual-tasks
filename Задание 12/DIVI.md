...
Чтобы применить алгоритм, для начала необходимо построить двудольный ориентированныйй граф.

![alt text](IMAGES/image-6.png)


Далее для построения сети необходимо в ориентированный граф добавть источник и сток

![alt text](IMAGES/image-7.png)

Далее для поиска максимального потока построим сеть:

![alt text](IMAGES/image.png)

    1 число на дуге - локальный поток
    2 число на дуге - пропускная способность дуги

Составляем остаточную сеть:
Число на прямой дуге - локальный поток, число на обратной дуге - резерв.
...
Для прямой дуги (локальный поток): направление прямое, стоимость с -

Для обратной дуги (резервный поток): направление обратное, стоимость с +
...
## Ответ: итоговая стоимость = 50 у.е

    От завода А к складу 1 - 5 единиц товара
    От завода В к складу 1 - 2 единицы товара
    От завода В к складу 2 - 5 единиц товара