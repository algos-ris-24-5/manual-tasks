...
1 число  - стоимость
2 число  - min из того, сколько можно провизвезти на заводе и сколько можно провезти на склад.

Составляем остаточную сеть:
Число на прямой дуге - локальный поток, число на обратной дуге - пропускная способность.
...
От завода А к складу 1 уходит 5 единиц товара
От завода В к складу 1 уходит 2 единицы товара
От завода В к складу 2 уходит 5 единиц товара