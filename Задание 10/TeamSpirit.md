...
## Этап 1
На остаточной сети был выбран путь **taS**, минимальное значение 2.

![alt text](TeamSpiritImages/NetStages/Stage1/BackNet.png)

Скорректируем исходную сеть, 

Локальный поток дуги S - a стал равен 2.

Локальный поток дуги a - t стал равен 2, дуга насыщенная.

![alt text](TeamSpiritImages/NetStages/Stage1/Net.png)


## Этап 2
На остаточной сети был выбран путь **tcS**, минимальное значение - 2.
![alt text](TeamSpiritImages/NetStages/Stage2/BackNet.png)

Скорректируем исходную сеть, 

Локальный поток дуги S - c стал равен 2.

Локальный поток дуги c - t стал равен 2, дуга насыщенная.

![alt text](TeamSpiritImages/NetStages/Stage2/Net.png)


## Этап 3
На остаточной сети был выбран путь **tbaS**, минимальное значение - 3.

![alt text](TeamSpiritImages/NetStages/Stage3/BackNet.png)

Скорректируем исходную сеть, 

Локальный поток дуги S - a стал равен 5.

Локальный поток дуги a - b стал равен 3, дуга насыщенная.

Локальный поток дуги b - t стал равен 3.

![alt text](TeamSpiritImages/NetStages/Stage3/Net.png)


## Этап 4
На остаточной сети был выбран путь **tbcS**, минимальное значение - 3

![alt text](TeamSpiritImages/NetStages/Stage4/BackNet.png)

Скорректируем исходную сеть, 

Локальный поток дуги S - c стал равен 5, дуга насыщенная.

Локальный поток дуги c - b стал равен 3.

Локальный поток дуги b - t стал равен 6.

![alt text](TeamSpiritImages/NetStages/Stage4/Net.png)


## Этап 5
На остаточной сети был выбран путь **tbcaS**, минимальное значение - 2

![alt text](TeamSpiritImages/NetStages/Stage5/BackNet.png)

Скорректируем исходную   сеть, 

Локальный поток дуги S - a стал равен 7, дуга насыщенная.

Локальный поток дуги a - c стал равен 2.

Локальный поток дуги c - b стал равен 5.

Локальный поток дуги b - t стал равен 8, дуга насыщенная.
