...
Чтобы вычислить пропускную способность разреза, нужно сложить пропускные способности дуг, выходящих из Vs в Vt.

![alt text](image-15.png)

Факт: Максимальный поток в сети не может быть больше минимальной пропускной способности резервов этой сети. Как видно из таблицы, минимальная пропускная способность - 16, как и получилось в задании.
