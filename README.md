...
В данном репозитории представлены задания для решения в ручную. Задания расположены в каталогах в ветке main текущего репозитория. Например, задание 1 в каталоге `Задание 1`. В каждом каталоге имеется файл README.md с описанием задания и информацией, необходимой для его выполнения.
