...
Приоритеты задач (по убыванию):
A(54),B(37),C(35),D(25),E(19),F(17) (приоритеты определяются по времени, которое нужно уделить на одну задачу)

Работника 1 назначаем на задачу A (т.к. у нее высший приоритет)

Работника 2 назначаем на задачу B (т.к. у нее высший приоритет после A)

Работника 3 назначаем на задачу C (т.к. у нее высший приоритет после B)

Работника 4 назначаем на задачу D (т.к. у нее высший приоритет после C)
