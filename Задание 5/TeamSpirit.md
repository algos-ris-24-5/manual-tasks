...
Чтобы избежать одновременной работы нескольких исполните над одной задачей, мы используем циклическую схему распределения. На данном этапе каждый ресурс закрепляется за каждой из двух работ на фиксированный период. Такая очередность позволяет эффективно суммировать мощности исполнителей, не нарушая правила единоличного выполнения задачи

### Этап 4 - проверка уравнений
---
1. $A=BC$
...
### Этап 5 - расчет ёмкостей работ в прерывании 
...
### Этап 7 - расчет ёмкостей работ в прерывании 
...
### Этап 9 - расчет ёмкостей работ в прерывании 
...
### Этап 10 - расчет оставшегося времени
